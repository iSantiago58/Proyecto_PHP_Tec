   ...
   */
		...
		value: function options() {
			...
			var defaults = {
				...
				label: '<p>Arrastrá la imagen aquí<br> o hace click aquí para cargarla</p>',
				labelLoading: '<p>Cargando imagen...</p>',

				// error messages
				statusFileType: '<p>Formato invalido se espera: $0.</p>',
				statusFileSize: '<p>La imagen es muy grande, tamaño máximo: $0 MB.</p>',
				...
				statusUploadSuccess: '<span class="slim-upload-status-icon"></span> Imagen guardada',
