class ColumnProductsComponent extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
                    ...
                    <div class="featured-product pt-sm-10 pt-xs-25">
                        ...
                        <div class="featured-product-active-2 owl-carousel">
                            <div class="featured-product-bundle">
                                ...
                                <feature-product price="1000.0" name="gran taza" imgpath="featured-product/2.jpg">
                                </feature-product>
                            </div>
                        </div>
                    </div>
...
customElements.define("column-products-component", ColumnProductsComponent);
