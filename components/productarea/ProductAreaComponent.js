var loadProducts; // Here's the difference

loadProducts = function () {
  var result = [];
  for (let index = 0; index < 4; index++) {
    var productoid = 23;
    var productodescripcion = "es un producto";
    var productoprecio = 233;
    var stock = 2;
    var categoriaid = 3;
    var productonombre = "nuevo producto";

    result.push(`<div class="col-lg-12">
                    <product-i
                        ...
                        stock=${stock}
                        categoriaid=${categoriaid}></product-i>
                 </div>`);
  }
  return result;
};

class ProductAreaComponent extends HTMLElement {
  connectedCallback() {
    var products = loadProducts();

    this.innerHTML = `<div class="product-area pt-55 pb-25 pt-xs-50">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
...
customElements.define("product-area-component", ProductAreaComponent);
