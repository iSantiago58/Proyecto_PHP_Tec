...
foreach($productos as $key => $p){
    ...
    if($stock==0 ){
        ...
        if(isset($_SESSION["ci"])){
            ...
            <li class="add-cart active" onclick="addToCart(${idProducto},'${nombreProd}','${descProd}',${precioProd},${stock},${ci},'${pathImg}');">
            <a>Add to cart</a></li>
            term;
        }
        $htmlAction=$htmlAction . <<<term
                ...
                <div class="col-lg-12">
                    <div class="li-product-tab">
                        <ul class="nav li-product-menu">
                            <li><a class="active" data-toggle="tab" ><span>${catName}</span></a></li>
                        </ul>
                    </div>
